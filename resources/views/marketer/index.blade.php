                    ...
                    <div class="mt-8 flex justify-center">
                        <div class="flex space-x-2">
                            @if (!$marketers->onFirstPage())
                                <a href="{{ $marketers->previousPageUrl() }}" class="px-3 py-2 rounded-lg bg-gray-800 text-purple-300 hover:bg-purple-700 hover:text-white transition">Previous</a>
                            @endif
                            ...
                            @foreach(range(1, $marketers->lastPage()) as $i)
                                ...
                                @else
                                    <a href="{{ $marketers->url($i) }}" class="px-3 py-2 rounded-lg bg-gray-800 text-purple-300 hover:bg-purple-700 hover:text-white transition">{{ $i }}</a>
                                @endif
                            @endforeach

                            @if ($marketers->hasMorePages())
                                <a href="{{ $marketers->nextPageUrl() }}" class="px-3 py-2 rounded-lg bg-gray-800 text-purple-300 hover:bg-purple-700 hover:text-white transition">Next</a>
                            @endif
                        </div>
                    </div>
                @endif
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            paginationLinks.forEach(link => {
                link.classList.add('page-link', 'px-3', 'py-2', 'rounded', 'border', 'border-purple-300', 'mx-1');
