                ...
                <form action="{{ route('marketer.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" step="0.01" name="price" value="{{ old('price') }}" required
                            class="w-full input-field p-3 rounded-lg text-white" placeholder="Enter price">
                        @error('price')
                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        <div class="file-upload relative rounded-lg p-4 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6极速赛车开奖结果记录.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 极速赛车开奖结果记录 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                        ...
                        <div class="bg-red-900 text-red-300 p-4 rounded-lg mb-6">
                            <h3 class="font-medium flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
                                        d="M10 18a8 8 0 100极速赛车开奖结果记录16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                                        clip-rule="evenodd" />
                                </svg>
