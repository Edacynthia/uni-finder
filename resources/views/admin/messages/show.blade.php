        ...
        <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6">
            ...
            @if (session('success'))
                <div class="bg-purple-300 text-purple-700 p-4 rounded-lg mb-6 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20极速赛车开奖结果记录"
                        fill="currentColor">
                        <path fill-rule="evenodd"
            ...
            @if (session('error'))
                <div class="bg-red-900 text-red-300 p-4 rounded-lg mb-6 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 极速赛车开奖结果记录 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                            clip-rule="evenodd" />
                    </svg>
                    {{ session('error') }}
                </div>
            ...
            <div class="message-container rounded-xl overflow-hidden mb-8">
                <div
                    class="px-6 py-5 border-b border-purple-500/40 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="space-y-2">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-purple-300" fill="none"
                        ...
                        <div class="flex items-center">
                            ...
                            <a href="mailto:{{ $message->email }}"
                                class="ml-2 text-purple-300 hover:text-white hover:underline transition">
                                {{ $message->email }}
                            </a>
                        </div>
                ...
                <div class="px-6 py-6">
                    <h2 class="text-xl font-semibold text-white mb-4 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-purple-300" fill="none"
                            viewBox="0 0 24 极速赛车开奖结果记录4" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="mt-8 flex flex-wrap gap-3">
                        ...
                        @else
                            <span
                                class="px-5 py-3 bg-gray-700 text-gray-300 rounded-lg font-medium inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7" />
                ...
                <div class="px-6 py-6">
                    <form action="{{ route('admin.messages.reply', $message->id) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="replyMessage" rows="5" class="w-full input-field p-4 rounded-lg text-white"
